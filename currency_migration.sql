...
CREATE INDEX IF NOT EXISTS idx_income_sources_currency ON public.income_sources(currency);
CREATE INDEX IF NOT EXISTS idx_assets_currency ON public.assets(currency);
CREATE INDEX IF NOT EXISTS idx_financial_goals_currency ON public.financial_goals(currency);
CREATE INDEX IF NOT EXISTS idx_budget_categories_currency ON public.budget_categories(currency);
